			...
			<thead>
		        <tr>
	            	...
	            	<
				      ...
				      <tbody>
				      	<?php
				      	$val=DB::select('select * from users where user_type_id_fk=3');
				      	...
				      	<tr>
				      		...
				      		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
				      		<td>
				      			<form action="/Admin/<?php echo e($cat->id); ?>/employestupdate">
...
<?php echo $__env->make('Admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\job4u\resources\views/admin/employers.blade.php ENDPATH**/ ?>