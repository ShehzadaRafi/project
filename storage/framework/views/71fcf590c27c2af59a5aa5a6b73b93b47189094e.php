          ...
          <div class="container">
            <div class="row">
              <div class="col-md-4 employee_data">
                <div class="style">
                <p class="text-center">
                  <img src="img/s1.jpg" width="80%">
                </p>
                <hr>
                <div class="list-inline">
                  <p class="text-justify float-left">Muhammad Ahmad</p>
                  <i class="fa fa-chain float-right mt-1"></i>
                </div>
                ...
                <a href="#" class="btn btn-dark btn-block">View More</a>
                </div>
              </div>
              <div class="col-md-4 employee_data">
                <div class="style">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\job4u\resources\views/user/candidate.blade.php ENDPATH**/ ?>